...
Aproach#1: Use [conda](http://conda.pydata.org/docs/using/index.html) as environment manager + package manager

Approach#2: Use environment manager `virtualenv` (+ virtualenvwrapper for managing virtualenvs) and `pip` as package manager.
...
```
3. Install a package you need:
```
% conda install $PACKAGE_NAME
```
4. Save a reference of the installed package versions:
```
...
[virtualenv documentation](https://virtualenv.pypa.io/en/stable/userguide/#usage)
[conda vs pip vs virtualenv](http://conda.pydata.org/docs/_downloads/conda-pip-virtualenv-translator.html)
