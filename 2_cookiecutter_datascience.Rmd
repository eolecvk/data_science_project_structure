...
Sphinx uses reStructuredText (`.rst`) as its markup language and support multiple output formats including html, LaTex, pdf.

[sphinx-doc tutorial](http://www.sphinx-doc.org/en/stable/tutorial.html)
