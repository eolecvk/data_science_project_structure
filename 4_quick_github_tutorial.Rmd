...
2. Initialize a git repository from the project folder: 
```
% git init
```

3. (optional) Create a README file in case you are not using the `cookiecutter` package which already contains a README.md file.
```
% touch Readme.txt
```

4. Connect local repo to GitHub repository
